...
void buildWeb(){
  ...
  webSite += "div{width:1000px; text-align: center; margin: 50 auto;}";
  webSite += "</style>";
  webSite += "</head>";
  webSite += "<body>";
  webSite += "<div>";
  webSite += "<h1>RGB led test IOT 11/23</h1>";
  webSite += "<p id=\"ledStatus\">Select RGB LED color</p>";
